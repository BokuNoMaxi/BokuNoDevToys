...
<div class="space-y-6">
	<div class="bg-slate-800 rounded-xl p-6">
		<h2 class="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-1.5">var_dump Output einfügen</h2>
		<p class="text-xs text-slate-600 mb-3">Unterstützt: string, int, float, bool, NULL, array, object — beliebig verschachtelt.</p>
		<textarea
			bind:value={input}
			onpaste={handlePaste}
			placeholder={'array(2) {\n  [0]=>\n  string(5) "hello"\n  [1]=>\n  int(42)\n}'}
	...
	{#if parsed !== null}
		<div class="bg-slate-800 rounded-xl p-6">
			<h2 class="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-4">Ergebnis</h2>
